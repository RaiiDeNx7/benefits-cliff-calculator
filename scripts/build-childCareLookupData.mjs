/**
 * Builds childCareLookupData.js from the FY2026 workbook.
 * Run from Cliff App: node scripts/build-childCareLookupData.mjs
 */
...
writeFileSync(join(root, "childCareLookupData.js"), body, "utf8");
console.log("Wrote childCareLookupData.js", { fpl: fplRows.length, limits: limitRows.length, localities: keys.length });
