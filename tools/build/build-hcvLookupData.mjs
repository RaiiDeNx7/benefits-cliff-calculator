 ...
 * Regenerate: npm run build:hcv-data
 */
...
writeFileSync(src.hcvLookup, body, "utf8");
console.log("Wrote src/programs/hcv/lookup-data.js", Object.keys(byLocality).length, "localities");
